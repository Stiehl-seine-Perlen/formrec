...
public class FormRecognizerTests {
	...
	@Test
	public void shouldNotThrowAnErorrWhenNotEverythingIsRecognized() throws IOException {
		// given a receipt with a missing total price
		String url = "https://wiesoso.com/img/content/74/kassenbon-entschluesselung.jpg";

		// when
		formRecognizer.recognize(url);

		// then
		// dont throw a null pointer exception
